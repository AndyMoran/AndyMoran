...
But my planning research case remains relevant today: Cuba is again experiencing severe energy constraints under the current US oil embargo, and the system‑level responses echo many of the same dynamics. Seeing those patterns recur reinforced something important — that uncertainty has a pattern, and intuition alone can’t capture that pattern. Reading Annie Duke’s Thinking in Bets and her probabilistic approach to decision‑making pushed me toward a more formal path: data analytics, data science, and the mathematical tools needed to think probabilistically about real‑world uncertainty.
