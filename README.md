...
I've now worked through the frequentist foundations and moved into Bayesian modelling. I've built projects that moved from "this seems straightforward" to "this is a lot more complicated than I thought" to "this model doesn't fit the data". I've iterated, failed, and actively invited criticism, because I want to get things right. Reading Annie Duke’s Thinking in Bets and her probabilistic approach to decision‑making pushed me toward a more formal path: data analytics, data science, and the mathematical tools needed to think probabilistically about real‑world uncertainty.
